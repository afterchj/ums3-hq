...
<body>
<h1>广播列表</h1>
<form id="mainForm" action="poll/poll2.action" method="get" class="form-horizontal">
    ...
    <ul class="nav nav-pills" style="margin-bottom: 2px;float: left;">
        <li id="pollNT">
            <a href="poll/poll2.action?filter_EQS_dtype=0">上线通知</a>
        </li>
       <!--  <li id="pollAD">
            <a href="poll/poll2.action?filter_EQS_dtype=1">抽屉广告</a>
        </li>
        <li id="pollCoop">
            <a href="poll/poll2.action?filter_EQS_dtype=2">厂商广告</a>
        </li> -->
    </ul>
    <div id="filter" style="margin-bottom:5px;">
         <div class="pull-right">
            <shiro:hasPermission name="store:edit">
                <a class="icon-plus" href="poll/poll2!input.action?dtype=${param['filter_EQS_dtype']}">新增</a>
            </shiro:hasPermission>
            &nbsp;<a href="javascript:void(0)" onclick="goXml();"><i class="icon-rss"></i></a>
        </div>
    </div>
    <table class="table table-hover">
        ...
        <s:iterator value="page.result">
            <tr>
                <td class="thumbnail_td"><img alt="图片" src="${ctx}/files/${imgLink}"></td>
                <td><a href="poll/poll2!input.action?id=${id}&pageNo=${page.pageNo}">${contentName}</a></td>
                <td>
                    <s:if test="status==0">
                        未发布
