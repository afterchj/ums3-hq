...
<body>
<h1>广播管理</h1>
<form id="inputForm" action="poll/poll2!save.action" method="post" class="form-horizontal" enctype="multipart/form-data">
    ...
    <fieldset>
        ...
        <div class="control-group">
            ...
            <div class="controls">
                <textarea class="input-xlarge url required" id="link" name="appUrl" maxlength="1024" rows="3">${appUrl}</textarea>
            </div>
        </div>
        <section id="spec">
            <div class="control-group">
            ...
            <div class="control-group">
                ...
                <div class="controls">
                    <input type="text" id="percent" name="percent" data-slider-step="10" data-slider-min="0" data-slider-max="300" data-slider-value="${percent}" value="${percent}" />
                </div>
            </div>
        </section>
    </fieldset>
