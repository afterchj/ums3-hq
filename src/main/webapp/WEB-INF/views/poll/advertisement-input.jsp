...
<form id="inputForm" action="poll/advertisement!save.action" method="post" class="form-horizontal"
    ...
    <fieldset>
        ...
        <div class="control-group">
            ...
            <div class="controls">
                <s:if test="dtype=='topic'">
                   <input type="text" value="专题广告" disabled="disabled">
                </s:if><s:elseif test="dtype=='store'">
                    <input type="text" value="商店顶部广告" disabled="disabled">
                </s:elseif>
                <s:elseif test="dtype=='sbot'">
                    <input type="text" value="商店底部广告" disabled="disabled">
                </s:elseif>
                <s:elseif test="dtype=='category'">
                    <input type="text" value="分类广告" disabled="disabled">
                </s:elseif>
            </div>
        </div>
        <div class="control-group">
            <label for="sort" class="control-label">内容类型:</label>
            <div class="controls">
				<s:select name="type" list="#{'' : '请选择', 'lock' : '普通锁屏', 'topic' : '专题', 'ad':'推广广告'}"></s:select>
            </div>
        </div>
        <div class="control-group">
