...
<form id="mainForm" action="file/spfile.action" method="post"
    ...
    <div>
        <ul class="nav nav-pills" style="margin-bottom: 2px;">
            ...
            <li id="categoryAll"><a href="file/spfile.action?categoryId=">全部</a>
            </li>
            <s:iterator value="parentTypes" var="parent">
                <li id="categoryId${parent.id}"><a
                        href="file/spfile.action?categoryId=${parent.id}">${parent.name}</a>
                </li>
            </s:iterator>
        </ul>
    </div>
    <div>
        <ul class="nav nav-pills" style="margin-bottom: 2px;">
            ...
            <li id="sonCategoryAll"><a
                    href="file/spfile.action?categoryId=${categoryId}&sonCategoryId=">全部</a>
            </li>
            <c:if test="${not empty subTypes}">
                <s:iterator value="subTypes" var="son">
                    <li id="sonCategoryId${son.id}"><a
                            href="file/spfile.action?categoryId=${categoryId}&sonCategoryId=${son.id}">${son.name}</a>
                    </li>
                </s:iterator>
            </c:if>
        </ul>
