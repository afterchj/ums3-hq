...
<script>
		...
		function deleteThis(id){
			if(confirm("确定要删除吗?")){
				window.location="account/group!delete.action?id="+id;
			}
		}
	</script>
</head>
...
<body>
    ...
    <div class="pull-right">
        <shiro:hasPermission name="group:edit">
            <a class="icon-plus" href="account/group!input.action">新增</a>
        </shiro:hasPermission>
    </div>
			...
			<c:forEach items="${groups}" var="group">
				<tr>
					...
					<td><shiro:hasPermission name="group:edit">
							<a href="account/group!input.action?id=${group.id}"><i class="icon-edit"></i></a> &nbsp;
							<a href="javascript:void(0)" onclick="deleteThis(${group.id})"><i class="icon-trash"></i></a>
