...
<form action="store/home.action" method="get">
    ...
    <div id="container">
        <div id="nav_second_level" class="nav_second_level">
            <a id="male" href="store/mpb-store.action?g=male">男生专区</a>
            <a id="female" href="store/mpb-store.action?g=female">女生专区</a>
        </div>
        <div class="content ajax-wrap">
            ...
            <div class="footer">
                <div class="J_scrollLoadMore load-btn click-state" data-api="store/mpb-store!shelfJson.action?g=${param.g}"></div>
