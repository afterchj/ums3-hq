...
<html lang="ja">
	...
	<body>
		<form action="store/jplocker.action" method="get">
			...
			<div id="container"> 		
				...
				<div style="font-size: 85%;">
					...
					<aside id="side-menu">
						<ul>
							<li><a href="store/help!device.action">対応機種</a></li>
							<br>
							 <li><a href="store/help!inquiry.action">お問い合わせ</a></li>
							<li><a href="store/help!tokusyou.action">特定商取引法</a></li>
						</ul>
					</aside>
					</s:if>
