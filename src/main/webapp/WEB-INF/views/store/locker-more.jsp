...
<html lang="en">
	...
	<body>
		...
		<form action="store/locker!more.action" method="get">
			...
			<nav id="page-nav">
  				<a href="store/?catePage.pageNo=${catePage.nextPage}&cid=${categoryId}"></a>
			</nav>
					...
					<div class="navigater">
						<s:iterator value="cateInfos">
							<div class="col_4 navitem">
				     			<a id="${category.id}" href="store/locker!more.action?cid=${category.id}&${queryString}" >${name}</a>
					  		</div>
						</s:iterator>
						<div class="col_4 navitem" style="float: right;">
							<a href="store/locker.action?${queryString}">
