...
<html>
	...
	<body>
		...
		<form action="store/locker!details.action" method="get">
			<div> 
				<div class="title_bar">
					${info.title}
				</div>
				...
				<div align="center">
					<a href="javascript:void(0)" id="downfree">
				...
				<div style="float: right;margin: 15px;">
					<a href="store/locker.action?${queryString}"><img id="gohome" alt="gohome" src="${ctx}/static/images/dhome.png"></a>
				</div>	
