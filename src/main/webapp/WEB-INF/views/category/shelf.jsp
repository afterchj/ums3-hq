					...
					function() {
						...
						var getData = function(sid) {
							$
									.ajax({
										dataType : "json",
										url : "category/shelf!filterShelf.action?sid="
												+ sid,
													...
													.each(
															...
															function(i, val) {
																html += "<tr><td>"
																		...
																		+ "</td><td>"
																		+ val.description
																		+ "</td><td><a href=category/shelf!manage.action?id="
																		+ val.id
																		+ "><i class='icon-cog'></i></a>&nbsp;&nbsp;"
																		+ "<a href=category/shelf!input.action?id="
																		+ val.id
																		+ "><i class='icon-edit'></i></a>&nbsp;&nbsp;"
																		+ "<a href=category/shelf!delete.action?id="
																		+ val.id
						...
						$("#createShelf").click(function() {
							location.href = "category/shelf!input.action?sid=" + sid;
						})
					});
</script>
</head>
<body>
	<form action="category/shelf.action" method="get" class="form-horizontal">
		<h1>货架列表</h1>
		...
		<div id="filter" style="margin-bottom: 5px;">
			...
			<div class="pull-right">
				<a class="icon-plus" href="javascript:void(0)" id="createShelf">新增</a>
			</div>
		</div>
