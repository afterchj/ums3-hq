...
<script>
	...
	$(function() {
		...
		var getRemainFileData = function(sfid) {
			$.ajax({
				dataType : "json",
				url : "category/market!remainFile.action?id=" + sfid,
		...
		var getShelfFileData = function(sfid) {
			$.ajax({
				dataType : "json",
				url : "category/market!fileInMarket.action?id=" + sfid,
				success : function(data) {
					var li = "";
...
<body>
	<form id="manageForm" action="category/market!appearOnMarket.action"
