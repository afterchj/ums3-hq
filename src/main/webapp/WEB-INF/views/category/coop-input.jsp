    ...
    <script>
        $(document).ready(function(){
            ...
            $("#inputForm").validate({
                rules:{
                value:{
                remote: "category/coop!checkName.action?oldValue=" + encodeURIComponent('${value}')
                }
                },
                messages:{
                value:{
...
<body>
<h1>厂商管理</h1>
<form id="inputForm" action="category/coop!save.action" method="post" class="form-horizontal">
