...
<html>
			...
			$(document).ready(function(){
				...
				$("#inputForm").validate({			
					rules:{
						name:{
							remote: {
			   	 				url: "category/diy!checkDiyName.action",     // 后台处理程序
			    				type: "post",               // 数据发送方式
	...
	<body>
		<h1>分类管理</h1>
		<form id="inputForm" action="category/diy!save.action" method="post" class="form-horizontal" enctype="multipart/form-data">
