...
<html>
			...
			$(document).ready(function(){
				...
				$("#inputForm").validate({
					...
					rules:{
						...
						//name:{
					//		remote: "category/shelf!checkShelfName.action?storeId=" + encodeURIComponent('${store.id}')+"&oldName="+encodeURIComponent('${name}')
					//	}
	...
	<body>
		<form id="inputForm" action="category/shelf!save.action" method="post" class="form-horizontal">
