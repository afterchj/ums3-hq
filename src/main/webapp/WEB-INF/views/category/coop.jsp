...
<head>
    ...
    <script>
        ...
        function deleteThis(id){
            if(confirm("确定要删除吗?")){
                window.location="category/coop!delete.action?id="+id;
            }
        }
    </script>
</head>
<body>
<form action="category/coop.action" method="get">
    <h1>厂商列表</h1>
    ...
    <div class="pull-right">
        <shiro:hasPermission name="category:edit">
            <a class="icon-plus" href="category/coop!input.action">新增</a>
        </shiro:hasPermission>
    </div>
        ...
        <s:iterator value="page.result">
            <tr>
                ...
                <td><shiro:hasPermission name="category:edit">
                    <a href="category/coop!input.action?id=${id}"><i class="icon-edit"></i></a>&nbsp;&nbsp;
