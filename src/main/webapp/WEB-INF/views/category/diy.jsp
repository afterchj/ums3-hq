...
<script>
			...
			function deleteThis(id){
				if(confirm("确定要删除吗?")){
					window.location="category/diy!delete.action?id="+id;
				}
			}
		</script>
</head>
<body>
	<form action="category/diy.action" method="get" class="form-horizontal">
		<h1>解锁文件分类</h1>
        ...
        <div class="pull-right">
            <shiro:hasPermission name="category:edit">
                <a class="icon-plus" href="category/diy!input.action">新增</a>
            </shiro:hasPermission>
        </div>
				...
				<s:iterator value="categories">
					<tr>
						...
						<td><shiro:hasPermission name="category:edit">
								<a href="category/diy!input.action?id=${id}"><i class="icon-edit"></i></a>
								<a href="category/diy-info.action?cid=${id}"><i class="icon-font" title="language"></i></a>
