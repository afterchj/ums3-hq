...
<html>
		...
		<script>
			$(document).ready(function(){
				...
				$("#inputForm").validate({
					rules:{
						name:{
							remote: "category/market!checkMarketName.action?oldName=" + encodeURIComponent('${name}')
						}
					},
	...
	<body>
		<form id="inputForm" action="category/market!save.action" method="post" class="form-horizontal">
