...
<html>
		...
		<script>
			$(document).ready(function(){
				...
				$("#inputForm").validate({
					rules:{
						name:{
							remote: "category/store!checkStoreName.action?oldStoreName=" + encodeURIComponent('${name}')
						},
						value:{
							remote: "category/store!checkStoreValue.action?oldValue=" +encodeURIComponent('${value}')
						}
					},
	...
	<body>
		<form id="inputForm" action="category/store!save.action" method="post" class="form-horizontal">
		...
		<input type="hidden" name="copyId" value="${copyId}">
			...
			<fieldset>
				...
				<div class="control-group">
					...
					<div class="controls">
						<s:radio name="description" list="#{'free':'免费','charge':'收费'}"
