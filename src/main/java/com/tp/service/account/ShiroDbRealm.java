...
public class ShiroDbRealm extends AuthorizingRealm {
	...
	protected AuthorizationInfo doGetAuthorizationInfo(PrincipalCollection principals) {
		...
		User user = userDao.findUniqueResultByProperty("loginName", shiroUser.getLoginName());
		if (user != null) {
	...
	public void clearCachedAuthorizationInfo(String principal) {
		SimplePrincipalCollection principals = new SimplePrincipalCollection(new ShiroUser(null,principal, null), getName());
	...
	public static void main(String[] args) {
		...
		byte[] hashPassword = Digests.sha1("linger".getBytes(), salt, INTERATIONS);
		result.password = Encodes.encodeHex(hashPassword);
